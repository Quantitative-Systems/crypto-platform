...
def run_full_dev_matrix():
    ...
    output_file = "/home/mrcn2/crypto-platform/proofs/research/h_mgt_1_profit_lock_1_0_results.json"
    with open(output_file, "w") as f:
        json.dump(dev_results_payload, f, indent=2)

    print(f"\nSuccessfully written H_MGT_1_PROFIT_LOCK_1_0 results to {output_file}")
