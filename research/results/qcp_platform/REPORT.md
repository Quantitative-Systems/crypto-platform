# Crypto Trading Platform — Strategy Research Report

_Generated 2026-09-22T16:46:28 · 104 books measured · 10 promoted · sweep 178.8s_
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| CARRY | funding_carry | PORTFOLIO | +11.159 | 78 | +5.486 | 29 | +4.790 | 26 | +0.000 | 1.0 | PROMOTABLE_PAPER_ONLY |
| INTRADAY | mean_revert | ADAUSDT | +0.111 | 91 | +0.144 | 44 | +0.267 | 29 | +0.244 | 1.0 | PROMOTABLE_PAPER_ONLY |
| INTRADAY | trend_breakout | ETHUSDT | +0.210 | 930 | +0.080 | 321 | +0.080 | 326 | +0.064 | 1.0 | PROMOTABLE_PAPER_ONLY |
| INTRADAY | trend_breakout | SOLUSDT | +0.143 | 259 | +0.107 | 70 | +0.082 | 75 | +0.065 | 1.0 | PROMOTABLE_PAPER_ONLY |
| POSITION | trend_breakout | ADAUSDT | +0.432 | 55 | +0.576 | 24 | +0.265 | 19 | +0.243 | 1.0 | PROMOTABLE_PAPER_ONLY |
| POSITION | trend_breakout | BNBUSDT | +0.593 | 61 | +0.237 | 19 | +0.627 | 16 | +0.590 | 1.0 | PROMOTABLE_PAPER_ONLY |
| POSITION | trend_rider | DOGEUSDT | +0.217 | 126 | +0.499 | 52 | +0.151 | 42 | +0.129 | 1.0 | PROMOTABLE_PAPER_ONLY |
| SWING | trend_breakout | ADAUSDT | +0.167 | 241 | +0.403 | 92 | +0.086 | 94 | +0.040 | 1.0 | PROMOTABLE_PAPER_ONLY |
| SWING | trend_breakout | ETHUSDT | +0.358 | 229 | +0.331 | 88 | +0.144 | 85 | +0.095 | 1.0 | PROMOTABLE_PAPER_ONLY |
| SWING | trend_breakout | SOLUSDT | +0.194 | 201 | +0.115 | 69 | +0.167 | 71 | +0.127 | 1.0 | PROMOTABLE_PAPER_ONLY |

## 4. Where the edge died

- **SCALP** (10 books): Promoted 0; died of data 0, alpha 0, stats 0, walk-forward 0, cost-shock 0.
- **INTRADAY** (15m clock, 40 books): median 1R = 113bps vs 5bps roundtrip (cost/stop = 0.044). Promoted 3; died of data 0, alpha 34, stats 1, walk-forward 0, cost-shock 0.
- **SWING** (1h clock, 30 books): median 1R = 277bps vs 22bps roundtrip (cost/stop = 0.079). Promoted 3; died of data 1, alpha 23, stats 0, walk-forward 0, cost-shock 3.
- **POSITION** (4h clock, 21 books): median 1R = 568bps vs 22bps roundtrip (cost/stop = 0.039). Promoted 3; died of data 1, alpha 14, stats 0, walk-forward 0, cost-shock 0.
...
- **CARRY** (1 books): Promoted 1; died of data 0, alpha 0, stats 0, walk-forward 0, cost-shock 0.
...
| trades_taken | 769 |
| trades_skipped | 14 |
| skip_reasons | {'MAX_CONCURRENT': 1, 'COOLDOWN': 13} |
| governor | {'equity': 1.576645, 'peak': 1.576923, 'drawdown': 0.0002, 'tripped': False, 'trip_reason': ''} |
| selected | ['CARRY|funding_carry|PORTFOLIO', 'INTRADAY|mean_revert|ADAUSDT', 'INTRADAY|trend_breakout|ETHUSDT', 'INTRADAY|trend_breakout|SOLUSDT', 'POSITION|trend_breakout|ADAUSDT', 'POSITION|trend_breakout|BNBUSDT', 'POSITION|trend_rider|DOGEUSDT', 'SWING|trend_breakout|ADAUSDT', 'SWING|trend_breakout|ETHUSDT', 'SWING|trend_breakout|SOLUSDT'] |
| dropped_g7 | ['INTRADAY|trend_breakout|BTCUSDT', 'INTRADAY|trend_breakout|BNBUSDT', 'POSITION|trend_breakout|XRPUSDT', 'POSITION|trend_rider|AVAXUSDT', 'POSITION|xs_momentum|PORTFOLIO'] |
| weights | {'POSITION|trend_breakout|BNBUSDT': 0.0822, 'CARRY|funding_carry|PORTFOLIO': 0.7158, 'INTRADAY|mean_revert|ADAUSDT': 0.0277, 'POSITION|trend_breakout|ADAUSDT': 0.0343, 'SWING|trend_breakout|SOLUSDT': 0.0391, 'POSITION|trend_rider|DOGEUSDT': 0.0218, 'SWING|trend_breakout|ETHUSDT': 0.0291, 'SWING|trend_breakout|ADAUSDT': 0.0168, 'INTRADAY|trend_breakout|SOLUSDT': 0.0102, 'INTRADAY|trend_breakout|ETHUSDT': 0.0229} |
