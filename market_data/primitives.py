...
class OpportunityType(str, Enum):
    """Categories of data-acquisition-worthy market anomalies (std lib only)."""
...
class OpportunityObservation:
    ...
    Moved here from the archived market_intelligence.opportunity_detector so
    the deployable data layer has zero dependencies on failed research code.
    """
    opportunity_id: str
