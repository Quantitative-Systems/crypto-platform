...
try:
    ...
    import re
    with open('strategy_candidate_v2/run_backtest.py', 'r') as f:
        content = f.read()
    
    new_content = content.replace("if tp3 is None or tp2 is None or tp1 is None:", "print(f'Checking None: {tp3 is None} {tp2 is None} {tp1 is None}'); if tp3 is None or tp2 is None or tp1 is None:")
    with open('strategy_candidate_v2/run_backtest.py', 'w') as f:
        f.write(new_content)
